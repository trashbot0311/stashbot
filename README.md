# stashbot
A discord bot with searchable database for gaming inventory/trading. Wishlists reported with search results for each user. Independent stash/wishlist between platform channels. Relied heavily on tutorial [here](https://www.youtube.com/watch?v=nW8c7vT6Hl4), have to give Lucas credit.
## Requirements
* Your Discord ID 
