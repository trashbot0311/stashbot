# stashbot
A discord bot with searchable database for gaming inventory/trading. Wishlists reported with search results for each user. Independent stash/wishlist between platform channels.
## Requirements
* Your Discord ID 
